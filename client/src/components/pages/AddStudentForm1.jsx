            ...
            <div className="container-fluid mt-4">
                <div className="row">
                    <div className="col-12">
                        ...
                        <span><i class="fas fa-tachometer-alt"></i> Dashboard</span> <span className="float-right"><NavLink to={'/'}><span className="pr-1">Home</span></NavLink> <i className="fas fa-angle-right" style={{fontSize:'14px'}}></i><i className="fas fa-angle-right" style={{fontSize:'14px'}}></i> <span className="pl-1 pr-1">Registration/Log In</span></span>           </div>
                    </div>
                </div>
                    <div className="row">
                        <div className="col-12">
                            ...
                            <div className="underline"></div>
                                ...
                                <div className="row mt-2">
                                    <div className="col-12 m-0 p-0">
                                        ...
                                        <div className={action==="Login"?"submit gray":"submit"} onClick={submitData}>Sign Up</div>
